...
public class Opciones extends Escena {
    ...
    public void dibujar(Canvas c) {
        ...
        c.drawText(context.getString(R.string.VIBRACION)+":"+(vibra?"ON":"OFF"),vibracion.left+((vibracion.right-vibracion.left)/2),altoPantalla/6*1,lapiz);
        ...
        switch (event.getAction()){
            case MotionEvent.ACTION_UP:
                if(vibracion.contains((int) event.getX(),(int) event.getY())) {
                    ...
                    editor.putBoolean("idioma",idiomaEspañol);
